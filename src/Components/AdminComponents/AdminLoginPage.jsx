...
const AdminLoginPage = () => {
  ...
  onSubmit: async (values, action) =>
    {
      try {
        setLoading(true)
        setError('')
        let response = await axios.post("http://localhost:8080/api/v1/admin/login", {email: values.email, password: values.password}, {withCredentials: true})
  ...
  return (
    <div className='w-full min-h-screen flex justify-center items-center bg-gray-400/30'>
      <div className="w-96 bg-white rounded-lg shadow-md p-6">
      <img src={logo} alt="logo" className='w-20 mb-2 mx-auto' />
      <div className="mb-4 h-28 flex items-center justify-center bg-gradient-to-r from-gray-600 to-gray-800 rounded-lg">
      ...
      <div className='flex items-center'>
        ...
        <button type='submit' className="w-full mt-4 bg-gray-700 text-white py-2 rounded-lg transition-transform duration-200 hover:scale-105 flex items-center justify-center">
          {
