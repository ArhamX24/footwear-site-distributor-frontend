  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, action) => {
      try {
        ...
        let response = await axios.post("https://footwear-site-distributor-backend-3.onrender.com/api/v1/distributor/login", {phoneNo, password}, {withCredentials: true})
        ...
        dispatch(setUserRole("distributor"))
        navigate('/secure/distributor/dashboard')
