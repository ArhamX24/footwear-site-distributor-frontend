...
const AdminDashboard = () => {
  ...
  const handleConfirmOrder = async (id) => {
    try {
      ...
      let response = await axios.post(`http://localhost:8080/api/v1/admin/products/orders/confrim/${id}`)
  ...
  return (
    <div>
      <div className='w-11/12 mx-auto flex flex-wrap justify-around '>
        <Smallcard name={"Products"} quantity={products?.length} icon={<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M4.00488 16V4H2.00488V2H5.00488C5.55717 2 6.00488 2.44772 6.00488 3V15H18.4433L20.4433 7H8.00488V5H21.7241C22.2764 5 22.7241 5.44772 22.7241 6C22.7241 6.08176 22.7141 6.16322 22.6942 6.24254L20.1942 16.2425C20.083 16.6877 19.683 17 19.2241 17H5.00488C4.4526 17 4.00488 16.5523 4.00488 16ZM6.00488 23C4.90031 23 4.00488 22.1046 4.00488 21C4.00488 19.8954 4.90031 19 6.00488 19C7.10945 19 8.00488 19.8954 8.00488 21C8.00488 22.1046 7.10945 23 6.00488 23ZM18.0049 23C16.9003 23 16.0049 22.1046 16.0049 21C16.0049 19.8954 16.9003 19 18.0049 19C19.1095 19 20.0049 19.8954 20.0049 21C20.0049 22.1046 19.1095 23 18.0049 23Z"></path></svg>} />
        <Smallcard name={"Orders"} quantity={orders?.length} icon={<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M12 1L21.5 6.5V17.5L12 23L2.5 17.5V6.5L12 1ZM5.49388 7.0777L13.0001 11.4234V20.11L19.5 16.3469V7.65311L12 3.311L5.49388 7.0777ZM4.5 8.81329V16.3469L11.0001 20.1101V12.5765L4.5 8.81329Z"></path></svg>}/>
        <Smallcard name={"Distributors"} quantity={distributors?.length} icon={<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M2 22C2 17.5817 5.58172 14 10 14C14.4183 14 18 17.5817 18 22H16C16 18.6863 13.3137 16 10 16C6.68629 16 4 18.6863 4 22H2ZM10 13C6.685 13 4 10.315 4 7C4 3.685 6.685 1 10 1C13.315 1 16 3.685 16 7C16 10.315 13.315 13 10 13ZM10 11C12.21 11 14 9.21 14 7C14 4.79 12.21 3 10 3C7.79 3 6 4.79 6 7C6 9.21 7.79 11 10 11ZM18.2837 14.7028C21.0644 15.9561 23 18.752 23 22H21C21 19.564 19.5483 17.4671 17.4628 16.5271L18.2837 14.7028ZM17.5962 3.41321C19.5944 4.23703 21 6.20361 21 8.5C21 11.3702 18.8042 13.7252 16 13.9776V11.9646C17.6967 11.7222 19 10.264 19 8.5C19 7.11935 18.2016 5.92603 17.041 5.35635L17.5962 3.41321Z"></path></svg>} />
        </div>
        ...
        <div className="w-11/12 mx-auto">
        {
          ...
          :
          <div className="w-11/12 mx-auto bg-gray-200 h-96 overflow-y-auto rounded-lg shadow-md p-5">
      {/* Table Headers */}
      ...
      {selectedOrder && (
        <div className="fixed inset-0 flex items-center justify-center bg-gray-800/50 z-50">
          <div className="bg-white w-full max-w-md p-6 rounded-lg shadow-lg">
            ...
            <span className='p-1 bg-gray-100 rounded-full cursor-pointer border' onClick={() => setSelectedOrder(null)}>
            ...
            <p><strong>Colors:</strong> {selectedOrder.colors.join(", ")}</p>
            <p><strong>Sizes No:</strong> {selectedOrder.sizes.join(", ")}</p>
